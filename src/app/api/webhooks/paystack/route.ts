 ...
 * 3. Find the user by email or reference
 * 4. Add the purchased coins via backend API
 * 5. Upgrade tier if it's a plan purchase
 *
 * Security: Paystack signs every webhook with HMAC-SHA512 using your secret key.
...
export async function POST(req: NextRequest) {
  try {
    ...
    // ============================================================
    // STEP 4: Determine what they bought based on amount
    // ============================================================
    let purchasedTier: string | null = null
    let coinsToAdd = 0

    // Check metadata first (if we stored it during checkout)
    ...
    // ============================================================
    // STEP 5: Add coins via Supabase RPC
    // ============================================================

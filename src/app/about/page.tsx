    ...
    <div className="bg-[#08080C]">
      ...
      <section className="bg-radial-glow bg-grid pt-16 pb-20 sm:pt-24 sm:pb-28">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-block px-4 py-1.5 rounded-full bg-[#1A1535] border border-[#7C5CFC]/20 mb-6">
            <span className="text-[12px] text-[#7C5CFC] font-semibold uppercase tracking-wider">About Us</span>
          </div>
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-[#F5F5F7] mb-6 leading-tight">
            We got tired of <span className="text-[#F87171]">bad leads.</span> <br />So we built the fix.
          </h1>
          <p className="text-lg sm:text-xl text-[#A8A8B8] max-w-2xl mx-auto leading-relaxed">
            Bad Decision AI did not start as a company. It started as a complaint.
      ...
      <section className="py-20 sm:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-6 text-[15px] sm:text-base text-[#A8A8B8] leading-relaxed">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#F5F5F7]">How it started.</h2>
            <p>
            ...
            <p>
              ...
              They said customers would not believe the promise. They said we would go broke refunding coins.
      ...
      <section className="py-20 sm:py-24 bg-[#0E0E14] border-y border-[#25252F]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#F5F5F7] mb-6">Why we are called Bad Decision.</h2>
          <div className="space-y-4 text-[15px] sm:text-base text-[#A8A8B8] leading-relaxed">
            ...
            <p className="text-xl text-[#F5F5F7] font-semibold pt-4">
              When you use Bad Decision AI, you are making a good one.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 sm:py-24">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#F5F5F7] mb-10 text-center">What we believe.</h2>
          <div className="grid sm:grid-cols-2 gap-6">
            {[
              ...
              <div key={i} className="card-premium p-7">
                <h3 className="text-lg font-bold text-[#F5F5F7] mb-3">{value.title}</h3>
                <p className="text-[14px] text-[#A8A8B8] leading-relaxed">{value.body}</p>
              </div>
            ))}
          </div>
        </div>

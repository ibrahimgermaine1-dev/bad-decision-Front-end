    ...
    <div className="bg-[#08080C]">
      ...
      <section className="py-20 sm:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="card-premium p-8 sm:p-10 bg-gradient-to-br from-[#14141C] to-[#1A1535] border-[#7C5CFC]/20">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#F5F5F7] mb-6">Our Promise To You</h2>
            <div className="space-y-4 text-[15px] sm:text-base text-[#A8A8B8] leading-relaxed">
              ...
              <p>
                ...
                And if we make a mistake, you get your coins back. Every single one.
                No questions. No forms. No waiting. You tell us it bounced, we refund the coins.
              </p>
              <p className="text-xl text-[#F5F5F7] font-semibold pt-2">
      ...
      {/* Why This Matters */}
      <section className="py-20 sm:py-24 bg-[#0E0E14] border-y border-[#25252F]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#F5F5F7] mb-8 text-center">Why this matters more than you think.</h2>
          <div className="space-y-6">
            <div className="card-premium p-6 sm:p-8">
              <h3 className="text-lg font-bold text-[#F5F5F7] mb-3">Dead emails kill your sender reputation.</h3>
            ...
            <div className="card-premium p-6 sm:p-8">
              <h3 className="text-lg font-bold text-[#F5F5F7] mb-3">Dead emails waste your time.</h3>
              <p className="text-[15px] text-[#A8A8B8] leading-relaxed">
            ...
            <div className="card-premium p-6 sm:p-8">
              <h3 className="text-lg font-bold text-[#F5F5F7] mb-3">Dead emails cost you money you cannot get back.</h3>
              <p className="text-[15px] text-[#A8A8B8] leading-relaxed">
                ...
                You never spend a coin on them. That money stays in your pocket.
      ...
      <section className="py-20 sm:py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-[#F5F5F7] mb-8 text-center">How we test every email.</h2>
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex items-start gap-5 card-premium p-6">
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#1A1535] border border-[#7C5CFC]/30 flex items-center justify-center">
                  <span className="text-[#7C5CFC] font-bold">{item.step}</span>
                </div>
                <div>
                  <h3 className="font-bold text-[#F5F5F7] mb-1">{item.title}</h3>
                  <p className="text-[14px] text-[#A8A8B8] leading-relaxed">{item.body}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 sm:py-24 bg-[#0E0E14] border-t border-[#25252F]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-[#A8A8B8] mb-8">
            ...
            Ask if they refund coins for bounces. They will change the subject. We will not.
          </p>
          <Link
            href="/sign-up"

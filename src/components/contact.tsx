  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col md:flex-row">
        {/* Left: Midnight Navy */}
        <div className="bg-[#0B1120] p-8 sm:p-10 md:p-16 md:w-1/2 flex flex-col justify-center">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white tracking-tight">Talk To Us.</h1>

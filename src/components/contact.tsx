  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col md:flex-row">
        ...
        <div className="bg-card p-8 sm:p-10 md:p-16 md:w-1/2 flex flex-col justify-center">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-card-foreground tracking-tight">Talk To Us.</h1>
          <p className="mt-4 text-card-foreground/70 text-lg leading-relaxed">
          ...
          <div className="mt-12 space-y-8">
            {[
              ...
              <div key={item.label}>
                <p className="text-card-foreground/60 text-sm uppercase tracking-wide">{item.label}</p>
                <p className="text-card-foreground font-medium mt-1">{item.value}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Right: White Form */}
        <div className="bg-white p-8 sm:p-10 md:p-16 md:w-1/2 flex flex-col justify-center">
          {submitted ? (
            <div className="text-center">
              ...
              <p className="mt-2 text-muted-foreground">We will get back to you fast.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <Input placeholder="Full name" className="border-border" required />
              </div>
              <div>
                <label className="block text-sm font-medium text-foreground mb-2">Email Address</label>
                <Input type="email" placeholder="you@company.com" className="border-border" required />
              </div>
              <div>
              ...
              <div>
                ...
                <Textarea placeholder="Tell us what you need..." className="border-border min-h-[120px]" required />
              </div>
              <Button type="submit" className="w-full bg-accent hover:bg-accent/90 text-white py-6 font-semibold text-base">
                Send Message
              </Button>
            </form>
          )}

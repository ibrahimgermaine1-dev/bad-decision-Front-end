  ...
  return (
    <div className="h-screen flex bg-white">
      ...
      <aside className="w-64 bg-[#F8FAFC] border-r border-[#E2E8F0] flex flex-col flex-shrink-0">
        ...
        <button onClick={() => setView('landing')} className="h-16 px-6 flex items-center gap-2 border-b border-[#E2E8F0] w-full">
        ...
        <div className="px-4 space-y-1">
          <button
            ...
            className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-colors flex items-center gap-2 ${activeSubView === 'idle' || activeSubView === 'searching' || activeSubView === 'results' ? 'bg-[#DBEAFE] text-[#2563EB]' : 'text-[#0F172A] hover:bg-white'}`}
          >
        ...
        <div className="border-t border-[#E2E8F0] p-4 space-y-1">
          ...
          <button
            ...
            className="w-full text-left px-3 py-2 rounded-lg text-sm text-[#0F172A] hover:bg-white transition-colors flex items-center gap-2"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="h-16 border-b border-[#E2E8F0] flex items-center justify-between px-6 flex-shrink-0">
          <div className="flex items-center gap-4">
            <button onClick={() => setView('landing')} className="flex items-center gap-2 text-[#64748B] hover:text-[#2563EB] transition-colors">
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M10 19l-7-7m0 0l7-7m-7 7h18" />
              </svg>
              <span className="text-sm">Back to Home</span>
            </button>
            <Separator className="h-6 bg-[#E2E8F0]" />

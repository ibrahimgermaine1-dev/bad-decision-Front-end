 ...
 * Navigation bar at top for easy return to site.
...
export function AuthPage() {
  const { setView, setTier, setAuthenticated, setCoinBalance } = useAppStore()
      ...
      <div className="bg-white border-b border-[#E2E8F0]">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <button onClick={() => setView('solutions')} className="text-sm text-[#0F172A] hover:text-[#2563EB] transition-colors">Solutions</button>

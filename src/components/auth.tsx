  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.status === 'complete') {
        setCoinBalance({ coins_balance: 250, coins_reserved: 0, coins_lifetime: 250 })
        setTier('free')
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-[var(--bg-primary)] rounded-2xl border border-[var(--border-color)] shadow-sm p-8">
          ...
          <p className="mt-2 text-[var(--text-secondary)] text-sm">
            {actualSignUp
              ? 'Get 250 free contacts when you sign up. No credit card needed.'
          ...
          <form onSubmit={actualSignUp ? handleSignUp : handleSignIn} className="mt-8 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <Input
                    ...
                    className="border-[var(--border-color)] h-11"
                    required
                  />
                </div>
                <div>
            ...
            {actualSignUp && (
              <div className="rounded-lg bg-[var(--bg-secondary)] border border-[var(--border-color)] p-4">
                <div className="flex items-center gap-3">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center ${scanComplete ? 'bg-[#DCFCE7]' : 'bg-[var(--color-accent)]/10'}`}>
                    {scanComplete ? (
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[var(--text-secondary)]">This protects against duplicate accounts</p>
                  </div>
                </div>
              </div>
            )}
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full bg-[var(--color-accent)] hover:bg-[var(--color-accent-hover)] text-white h-11 font-semibold"
            >
          ...
          <Button
            ...
            className="w-full border-[var(--border-color)] h-11 font-medium text-[var(--text-primary)]"
          >

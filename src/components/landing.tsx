...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="bg-white py-24 md:py-32">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              Start Free — 50 Contacts Included
            </Button>
            <Button
              size="lg"
              variant="outline"
      ...
      {/* ============================================================ */}
      {/* PRICING PREVIEW — Show 3 tiers on landing page */}
      {/* ============================================================ */}
      <section className="bg-[#F8FAFC] py-20">
        <div className="max-w-6xl mx-auto px-6">
            ...
            {[
              {
                ...
                priceUSD: 15,
                priceNGN: 12000,
                features: ['1,500 coins per month', 'Live Internet Scan', 'Find Decision Makers', 'All 4 search types'],
              },
              {
                name: 'Growth',
                coins: 3000,
                ...
                priceNGN: 20000,
                popular: true,
                features: ['3,000 coins per month', 'Priority Contact Check', 'Smart Collections', 'All 4 search types'],
              },
              {
                name: 'Pro',
                coins: 5000,
                priceUSD: 35,
                priceNGN: 28000,
                features: ['5,000 coins per month', 'Guaranteed Inbox Test', 'Catch-all Detection', 'Full CSV Export'],
              },
            ].map((plan) => {
                  ...
                  <ul className="mt-6 space-y-2">
                    {plan.features.map((f) => (
                      <li key={f} className="flex items-center gap-2">
                        <svg className={`w-4 h-4 flex-shrink-0 ${isInverted ? 'text-[#2563EB]' : 'text-[#2563EB]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-[#64748B]">
              Every new account gets <span className="font-semibold text-[#0F172A]">50 free coins</span>. No credit card needed.
            </p>
            <Button
              onClick={() => setView('pricing')}
              variant="outline"
              className="mt-4 border-[#2563EB] text-[#2563EB] hover:bg-[#DBEAFE]"
            >

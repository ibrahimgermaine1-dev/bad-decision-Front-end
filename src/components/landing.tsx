    ...
    <div className="min-h-screen">
      ...
      <section className="bg-white py-16 sm:py-24 md:py-32">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold text-[#0F172A] tracking-tight leading-[1.05]">
      ...
      <section className="bg-[#F8FAFC] py-16 sm:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="rounded-2xl border-2 border-red-200 bg-white p-8 sm:p-10">
            ...
            <div className="rounded-2xl bg-[#0B1120] p-8 sm:p-10">
      ...
      <section id="how-it-works" className="bg-white py-16 sm:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#0F172A]">Three Steps. Real Results.</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.step} className="rounded-2xl border border-[#E2E8F0] bg-white p-6 sm:p-8 shadow-sm hover:shadow-md transition-shadow">

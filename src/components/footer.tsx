      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2.5 mb-4">
              ...
              <div>
                ...
                <span className="block text-[10px] text-card-foreground/60 -mt-0.5 tracking-wide uppercase">Lead Intelligence</span>
              </div>
            </Link>
            <p className="text-[14px] text-card-foreground/80 leading-relaxed max-w-sm">
            ...
            <p className="mt-6 text-[13px] text-card-foreground/60">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/about" className="text-[14px] text-card-foreground/70 hover:text-primary transition-colors">About Us</Link></li>
              <li><Link href="/guarantee" className="text-[14px] text-card-foreground/70 hover:text-primary transition-colors">Our Guarantee</Link></li>
              <li><Link href="/faq" className="text-[14px] text-card-foreground/70 hover:text-primary transition-colors">FAQ</Link></li>
              <li><Link href="/contact" className="text-[14px] text-card-foreground/70 hover:text-primary transition-colors">Contact</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/terms" className="text-[14px] text-card-foreground/70 hover:text-primary transition-colors">Terms of Service</Link></li>
              <li><Link href="/privacy" className="text-[14px] text-card-foreground/70 hover:text-primary transition-colors">Privacy Policy</Link></li>
              <li><Link href="/refund" className="text-[14px] text-card-foreground/70 hover:text-primary transition-colors">Refund Policy</Link></li>
            </ul>
          </div>
        </div>
